...
void Tag_follow_class::nav_callback(const ardrone_autonomy::NavdataConstPtr& nav_msg)
{
	...
	this->error[errorIdxZ]  = 110 - nav_msg->tags_distance[0];	// Distance in centimeters
 ...
 void Tag_follow_class::pidcontroller()
{
	...
	//the following is to limit the input to the drone. 
	/*
	 ...
	 The following was the stuff added to see how the drone moves with various inputs
